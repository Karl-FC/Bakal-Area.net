...
import { SheardesignTableService, BeamShape} from './sheardesign-table.service';


@Component({
  selector: 'app-sheardesign-table',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, MatSortModule],
  templateUrl: './sheardesign-table.component.html',
  styleUrl: './sheardesign-table.component.scss'
})
export class SheardesignTableComponent implements OnInit {
  @ViewChild(MatSort) sort!: MatSort;
  dataSource!: MatTableDataSource<any>;
  beamShapes$ = this.updater.beamShapes$;
  beamFilters = new FormControl('');

  constructor(public updater: SheardesignTableService) {
